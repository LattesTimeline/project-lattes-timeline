...
- 3.2.2. <a id="view_lt_timeline">lt_timeline</a>
...
## 3.2.3. <a id="view_chart">Chart</a>

Arquivos que codificam as views de visualização dos gráficos.

- 3.2.3.1. <a id="view_lt_chart">lt_chart</a>
...
## 3.2.4. <a id="view_errors">Errors</a>

Arquivos que codificam as views de erros da aplicação.


## 3.2.5. <a id="view_subviews">Subviews</a>

Arquivos que codificam as subviews da aplicação. Cada subview representa uma
parte da aplicação.

- 3.2.5.1. <a id="view_lt_timeline_content">lt_timeline_content</a>

>  Subview que representa a estrutura geral da timeline.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.2. <a id="view_lt_timeline_content_year_boards">lt_timeline_content_year_boards</a>

>  Subview que representa a parte de bancas de jurado.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.3. <a id="view_lt_timeline_content_year_orientations">lt_timeline_content_year_orientations</a>

>  Subview que representa a parte de orientações.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.4. <a id="view_lt_timeline_content_year_productions">lt_timeline_content_year_productions</a>

>  Subview que representa a parte de produções.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.5. <a id="view_lt_timeline_content_year_projects">lt_timeline_content_year_projects</a>

>  Subview que representa a parte de projetos.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.6. <a id="view_lt_timeline_content_years">lt_timeline_content_years</a>

>  Subview que representa a parte da página com os anos de publicações.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.5.7. <a id="view_lt_timeline_filter">lt_timeline_filter</a>
...
## 3.2.6. <a id="view_template">Template</a>

Arquivos que codificam as partes do template das páginas.

- 3.2.6.1. <a id="view_lt_header">lt_header</a>

>  Template com o cabeçalho.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.6.2. <a id="view_lt_menu">lt_menu</a>

>  Template com o menu.
> <br><br>
> CRIADOR : Felipe Chagas

- 3.2.6.3. <a id="view_lt_footer">lt_footer</a>
...
## 3.3. <a id="lt_controllers">Controllers</a>

Classes responsáveis pela funcionalidade de controle da aplicação.

- 3.3.1. <a id="lt_index">lt_index</a>
...
- 3.3.2. <a id="lt_uploader">lt_uploader</a>
...
- 3.3.3. <a id="lt_timeline_generator">lt_timeline_generator</a>
...
## 3.4. <a id="lt_libraries">Libraries</a>

Classes de biblioteca segundo o padrão do framework C.I.

- 3.4.1. <a id="MY_LT_LIB">MY_LT_LIB</a>
